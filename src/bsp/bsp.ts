...
export namespace BuildTargetSources {
  ...
  export const type = new RequestType<SourcesParams, SourcesResult, void>(
    method
  )
  export type HandlerSignature = RequestHandler<
    SourcesParams,
...
export namespace BuildTargetInverseSources {
  export const method: 'buildTarget/inverseSources' =
...
export namespace BuildTargetDependencySources {
  export const method: 'buildTarget/dependencySources' =
...
export namespace BuildTargetDependencyModules {
  export const method: 'buildTarget/dependencyModules' =
...
export namespace BuildTargetResources {
  ...
  export const type = new RequestType<ResourcesParams, ResourcesResult, void>(
    method
  )
  export type HandlerSignature = RequestHandler<
    ResourcesParams,
...
export namespace BuildTargetCompile {
  ...
  export const type = new RequestType<CompileParams, CompileResult, void>(
    method
  )
  export type HandlerSignature = RequestHandler<
    CompileParams,
...
export namespace BuildTargetCleanCache {
  ...
  export const type = new RequestType<CleanCacheParams, CleanCacheResult, void>(
    method
  )
  export type HandlerSignature = RequestHandler<
    CleanCacheParams,
...
export namespace SetCargoFeatures {
  export const method: 'workspace/setCargoFeatures' =
    'workspace/setCargoFeatures'
  export const type = new RequestType<
...
export namespace BuildTargetCppOptions {
  ...
  export const type = new RequestType<CppOptionsParams, CppOptionsResult, void>(
    method
  )
  export type HandlerSignature = RequestHandler<
    CppOptionsParams,
...
export namespace BuildTargetJvmTestEnvironment {
  export const method: 'buildTarget/jvmTestEnvironment' =
...
export namespace BuildTargetJvmRunEnvironment {
  export const method: 'buildTarget/jvmRunEnvironment' =
...
export namespace BuildTargetScalaTestClasses {
  export const method: 'buildTarget/scalaTestClasses' =
...
export namespace BuildTargetScalaMainClasses {
  export const method: 'buildTarget/scalaMainClasses' =
